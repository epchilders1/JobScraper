...
class BaseJobMatch(_PrismaModel):
    __prisma_model__: ClassVar[Literal['JobMatch']] = 'JobMatch'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.JobMatchActions[_PrismaModelT]':
        from .client import get_client

        return actions.JobMatchActions[_PrismaModelT](client or get_client(), cls)
